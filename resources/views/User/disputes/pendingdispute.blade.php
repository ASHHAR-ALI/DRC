@section('title', 'Pending Disputes') <!-- Web browser Tab Title -->
@section('disputetitle', 'Pending Disputes') <!-- Setting Page Title -->
@section('dispute')
                        ...
                        @foreach ($pendingdisputes as $dispute)
                            <tr class="text-center">
                                ...
                                <td>
                                    ...
                                    @elseif ($dispute->member_id !== null && $dispute->dispute_status === 4 && $dispute->assigned_date === 4)
