...
<head>
    ...
    <!-- Font Awesome-->
    <link rel="stylesheet" type="text/css" href="{{ asset('allassets/AdminTheme/MulticartTheme/css/vendors/font-awesome.css') }} ">

    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="{{ asset('allassets/AdminTheme/MulticartTheme/css/vendors/flag-icon.css') }} ">

    <!-- ico-font-->
    <link rel="stylesheet" type="text/css" href="{{ asset('allassets/AdminTheme/MulticartTheme/css/vendors/icofont.css') }} ">

    <!-- Prism css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('allassets/AdminTheme/MulticartTheme/css/vendors/prism.css') }} ">

    <!-- Chartist css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('allassets/AdminTheme/MulticartTheme/css/vendors/chartist.css') }} ">

    <!-- Bootstrap css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('allassets/AdminTheme/MulticartTheme/css/vendors/bootstrap.css') }} ">

    <!-- App css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('allassets/AdminTheme/MulticartTheme/css/style.css') }} ">
                    ...
                    <div class="logo-wrapper">
                        <a href="index.html">
                            <img class="blur-up lazyloaded d-block d-lg-none"
                                src="{{ asset('allassets/images/DRC.png') }} " alt="">
                        </a>
                    </div>
                </div>
                    ...
                    <ul class="nav-menus ">
                        <li class="nav-item ">
                            <a class="nav-link link-success link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover"
                                href="{{ asset('/index2') }}">Home</a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link link-success link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover"
                                href="{{ asset('/index2') }}">About</a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link link-success link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover"
                                href="{{ asset('/index2') }}">FAQs</a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link link-success link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover"
                                href="{{ asset('/index2') }}">Contacts</a>
                        </li>
                        ...
                        {{-- ---------------------------- Link Tag for Showing Friendlist ---------------------------- --}}
                        {{-- <li>
                            <a href="javascript:void(0)">
                        ...
                        <li class="onhover-dropdown">
                            <div class="media align-items-center">
                                <img class="align-self-center pull-right img-50 blur-up lazyloaded" src="{{ asset('allassets/images/DRC.png') }} " alt="header-user">
                    ...
                    <div class="logo-wrapper">
                        <a href="index.html">
                            <img class="d-none d-lg-block blur-up lazyloaded"
                                src="{{ asset('allassets/AdminTheme/MulticartTheme/images/dashboard/multikart-logo.png') }} " alt="">
                        </a>
                    </div>
                </div>
                    ...
                    <div class="p-l-30 p-r-30 friend-list-name">
                        <div class="chat-box">
                            <div class="people-list friend-list">
                                <ul class="list">
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded" src="{{ asset('allassets/AdminTheme/MulticartTheme/images/dashboard/user.jpg') }} " alt="">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded" src="{{ asset('allassets/AdminTheme/MulticartTheme/images/dashboard/user1.jpg') }} " alt="">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded" src="{{ asset('allassets/AdminTheme/MulticartTheme/images/dashboard/user2.jpg') }} " alt="">
                                        <div class="status-circle online"></div>
                                        <div class="about">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded" src="{{ asset('allassets/AdminTheme/MulticartTheme/images/dashboard/user3.jpg') }} " alt="">
                                        <div class="status-circle online"></div>
                                        <div class="about">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded" src="{{ asset('allassets/AdminTheme/MulticartTheme/images/dashboard/user5.jpg') }} " alt="">
                                        <div class="status-circle away"></div>
                                        <div class="about">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded" src="{{ asset('allassets/AdminTheme/MulticartTheme/images/dashboard/designer.jpg') }} " alt="">
                                        <div class="status-circle online"></div>
                                        <div class="about">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="bd-t-none u-s-tb">
                                                        <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('allassets/AdminTheme/MulticartTheme/images/dashboard/user2.jpg') }} " alt="" data-original-title="" title="">
                                                ...
                                                <tr>
                                                    <td class="bd-t-none u-s-tb">
                                                        <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('allassets/AdminTheme/MulticartTheme/images/dashboard/user1.jpg') }} " alt="" data-original-title="" title="">
                                                            <div class="d-inline-block">
                                                ...
                                                <tr>
                                                    <td class="bd-t-none u-s-tb">
                                                        <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('allassets/AdminTheme/MulticartTheme/images/dashboard/user3.jpg') }} " alt="" data-original-title="" title="">
                                                            <div class="d-inline-block">
                                                ...
                                                <tr>
                                                    <td class="bd-t-none u-s-tb">
                                                        <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('allassets/AdminTheme/MulticartTheme/images/dashboard/user.jpg') }} " alt="" data-original-title="" title="">
                                                            <div class="d-inline-block">
                                                ...
                                                <tr>
                                                    <td class="bd-t-none u-s-tb">
                                                        <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('allassets/AdminTheme/MulticartTheme/images/dashboard/designer.jpg') }} " alt="" data-original-title="" title="">
                                                            <div class="d-inline-block">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="code-box-copy">
                                        <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#example-head2" title="" data-original-title="Copy">
...
&lt;/div&gt;</code>
    ...
    <!-- latest jquery-->
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/jquery-3.3.1.min.js') }} "></script>

    <!-- Bootstrap js-->
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/bootstrap.bundle.min.js') }} "></script>

    <!-- feather icon js-->
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/icons/feather-icon/feather.min.js') }} "></script>
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/icons/feather-icon/feather-icon.js') }} "></script>

    <!-- Sidebar jquery-->
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/sidebar-menu.js') }} "></script>

    <!--chartist js-->
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/chart/chartist/chartist.js') }} "></script>

    <!--chartjs js-->
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/chart/chartjs/chart.min.js') }} "></script>

    <!-- lazyload js-->
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/lazysizes.min.js') }} "></script>

    <!--copycode js-->
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/prism/prism.min.js') }} "></script>
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/clipboard/clipboard.min.js') }} "></script>
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/custom-card/custom-card.js') }} "></script>

    <!--counter js-->
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/counter/jquery.waypoints.min.js') }} "></script>
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/counter/jquery.counterup.min.js') }} "></script>
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/counter/counter-custom.js') }} "></script>

    <!--peity chart js-->
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/chart/peity-chart/peity.jquery.js') }} "></script>

    <!-- Apex Chart Js -->
    <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>

    <!--sparkline chart js-->
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/chart/sparkline/sparkline.js') }} "></script>

    <!--Customizer admin-->
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/admin-customizer.js') }} "></script>

    <!--dashboard custom js-->
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/dashboard/default.js') }} "></script>

    <!--right sidebar js-->
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/chat-menu.js') }} "></script>

    <!--height equal js-->
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/height-equal.js') }} "></script>

    <!-- lazyload js-->
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/lazysizes.min.js') }} "></script>

    <!--script admin-->
    <script src="{{ asset('allassets/AdminTheme/MulticartTheme/js/admin-script.js') }} "></script>
</body>
