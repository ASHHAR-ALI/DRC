...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180"
        href="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/apple-touch-icon.png ') }}" />
    <link rel="icon" type="image/png" sizes="32x32"
        href="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/favicon-32x32.png ') }}" />
    <link rel="icon" type="image/png" sizes="16x16"
        href="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/favicon-16x16.png ') }}" />
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap"
        rel="stylesheet" />
    <!-- CSS -->
    <link rel="stylesheet" type="text/css" href="{{ asset('/allassets/AdminTheme/Theme02/vendors/styles/core.css') }}" />
    <link rel="stylesheet" type="text/css"
        href="{{ asset('/allassets/AdminTheme/Theme02/vendors/styles/icon-font.min.css') }}" />
    <link rel="stylesheet" type="text/css"
        href="{{ asset('/allassets/AdminTheme/Theme02/src/plugins/datatables/css/dataTables.bootstrap4.min.css') }}" />
    <link rel="stylesheet" type="text/css"
        href="{{ asset('/allassets/AdminTheme/Theme02/src/plugins/datatables/css/responsive.bootstrap4.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('/allassets/AdminTheme/Theme02/vendors/styles/style.css') }}" />
...
<body>
   ...
   <div class="pre-loader-box">
    <div class="loader-logo">
     <img src="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/deskapp-logo.svg') }}" alt="" />
    </div>
    ...
    <div class="loading-text">Loading...</div>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="notification-list mx-h-350 customscroll">
                                <ul>
                                    <li>
                                        <a href="#">
                                            <img src="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/img.jpg') }}"
                                                alt="" />
                                            <h3>John Doe</h3>
                                            <p>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img src="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/photo2.jpg') }}"
                                                alt="" />
                                    ...
                                    <li>
                                        <a href="#">
                                            <img src="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/photo3.jpg') }}"
                                                alt="" />
                                            <h3>John Doe</h3>
                                            <p>
                                                Lorem ipsum dolor sit amet, consectetur adipisicing
                                    ...
                                    <li>
                                        <a href="#">
                                            <img src="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/photo4.jpg') }}"
                                                alt="" />
     ...
     <a href="https://github.com/dropways/deskapp" target="_blank"
      ><img src="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/github.svg') }}" alt=""
     /></a>
    </div> -->
            </div>
        </div>
        ...
        <div class="left-side-bar">
            <div class="brand-logo">
                <a href="index.html">
                    <img src="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/deskapp-logo.svg') }}" alt=""
                        class="dark-logo" />
                    <img src="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/deskapp-logo-white.svg') }}"
                        ...
                        <li>
                            <a href="https://dropways.github.io/deskapp-free-single-page-website-template/"
                                ...
                                <span class="mtext">Landing Page
                                    <img src="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/coming-soon.png') }}"
                                        alt="" width="25" /></span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="col-lg-4 col-md-12 mb-20">
                        <div class="card-box height-100-p pd-20 min-height-200px">
                            <div class="max-width-300 mx-auto">
                                <img src="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/upgrade.svg') }}"
                                    alt="" />
                            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="table-plus">
                                    <div class="name-avatar d-flex align-items-center">
                                        <div class="avatar mr-2 flex-shrink-0">
                                            <img src="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/photo5.jpg') }}"
                                                class="border-radius-100 shadow" width="40" height="40"
                                                alt="" />
                                        </div>
                                        <div class="txt">
                            ...
                            <tr>
                                <td class="table-plus">
                                    <div class="name-avatar d-flex align-items-center">
                                        <div class="avatar mr-2 flex-shrink-0">
                                            <img src="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/photo6.jpg') }}"
                                                class="border-radius-100 shadow" width="40" height="40"
                                                alt="" />
                                        </div>
                                        <div class="txt">
                            ...
                            <tr>
                                <td class="table-plus">
                                    <div class="name-avatar d-flex align-items-center">
                                        <div class="avatar mr-2 flex-shrink-0">
                                            <img src="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/photo9.jpg') }}"
                                                class="border-radius-100 shadow" width="40" height="40"
                                                alt="" />
                                        </div>
                                        <div class="txt">
                            ...
                            <tr>
                                <td class="table-plus">
                                    <div class="name-avatar d-flex align-items-center">
                                        <div class="avatar mr-2 flex-shrink-0">
                                            <img src="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/photo8.jpg') }}"
                                                class="border-radius-100 shadow" width="40" height="40"
                                                alt="" />
                                        </div>
                                        <div class="txt">
                ...
                <div class="row">
                    <div class="col-md-4 mb-20">
                        <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                            <div class="img pb-30">
                                <img src="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/medicine-bro.svg') }}"
                                    alt="" />
                            </div>
                            <div class="content">
                    ...
                    <div class="col-md-4 mb-20">
                        <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                            <div class="img pb-30">
                                <img src="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/remedy-amico.svg') }}"
                                    alt="" />
                            </div>
                            <div class="content">
                    ...
                    <div class="col-md-4 mb-20">
                        <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                            <div class="img pb-30">
                                <img src="{{ asset('/allassets/AdminTheme/Theme02/vendors/images/paper-map-cuate.svg') }}"
                                    alt="" />
                            </div>
                            <div class="content">
        ...
        <script src="{{ asset('/allassets/AdminTheme/Theme02/vendors/scripts/core.js') }}"></script>
        <script src="{{ asset('/allassets/AdminTheme/Theme02/vendors/scripts/script.min.js') }}"></script>
        <script src="{{ asset('/allassets/AdminTheme/Theme02/vendors/scripts/process.js') }}"></script>
        <script src="{{ asset('/allassets/AdminTheme/Theme02/vendors/scripts/layout-settings.js') }}"></script>
        <script src="{{ asset('/allassets/AdminTheme/Theme02/src/plugins/apexcharts/apexcharts.min.js') }}"></script>
        <script src="{{ asset('/allassets/AdminTheme/Theme02/src/plugins/datatables/js/jquery.dataTables.min.js') }}"></script>
        <script src="{{ asset('/allassets/AdminTheme/Theme02/src/plugins/datatables/js/dataTables.bootstrap4.min.js') }}"></script>
        <script src="{{ asset('/allassets/AdminTheme/Theme02/src/plugins/datatables/js/dataTables.responsive.min.js') }}"></script>
        <script src="{{ asset('/allassets/AdminTheme/Theme02/src/plugins/datatables/js/responsive.bootstrap4.min.js') }}"></script>
        <script src="{{ asset('/allassets/AdminTheme/Theme02/vendors/scripts/dashboard3.js') }}"></script>
