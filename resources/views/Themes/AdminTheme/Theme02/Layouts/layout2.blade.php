...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset('allassets/AdminTheme/Theme02/images/favicon.ico') }} ">

    <!-- jvectormap -->
    <link href="{{ asset('allassets/AdminTheme/Theme02/libs/jqvmap/jqvmap.min.css') }}" rel="stylesheet" />

    <!-- DataTables -->
    <link href="{{ asset('allassets/AdminTheme/Theme02/libs/datatables/dataTables.bootstrap4.min.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('allassets/AdminTheme/Theme02/libs/datatables/responsive.bootstrap4.min.css') }}" rel="stylesheet" type="text/css"/>

    <!-- App css -->
    <link href="{{ asset('allassets/AdminTheme/Theme02/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('allassets/AdminTheme/Theme02/css/icons.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('allassets/AdminTheme/Theme02/css/app.min.css') }}" rel="stylesheet" type="text/css" />
...
<body>
                ...
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown d-none d-lg-block">
                        <a class="nav-link dropdown-toggle mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="{{ asset('allassets/AdminTheme/Theme02/images/flags/us.jpg') }}" alt="user-image" class="mr-1" height="12"> <span class="align-middle">English <i class="mdi mdi-chevron-down"></i> </span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('allassets/AdminTheme/Theme02/images/flags/germany.jpg') }}" alt="user-image" class="mr-1" height="12"> <span class="align-middle">German</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('allassets/AdminTheme/Theme02/images/flags/italy.jpg') }}" alt="user-image" class="mr-1" height="12"> <span class="align-middle">Italian</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('allassets/AdminTheme/Theme02/images/flags/spain.jpg') }}" alt="user-image" class="mr-1" height="12"> <span class="align-middle">Spanish</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('allassets/AdminTheme/Theme02/images/flags/russia.jpg') }}" alt="user-image" class="mr-1" height="12"> <span class="align-middle">Russian</span>
                            </a>
                            ...
                            <div class="slimscroll noti-scroll">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon">
                                        <img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-2.jpg') }}" class="img-fluid rounded-circle" alt="" /> </div>
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon">
                                        <img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-4.jpg') }}" class="img-fluid rounded-circle" alt="" /> </div>
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-4.jpg') }}" alt="user-image" class="rounded-circle">
                ...
                <ul class="list-unstyled menu-left mb-0">
                    <li class="float-left logo-box">
                        <a href="index.html" class="logo">
                            <span class="logo-lg">
                                <img src="{{ asset('allassets/AdminTheme/Theme02/images/logo-light.png') }} " alt="" height="22">
                            </span>
                            <span class="logo-sm">
                                <img src="{{ asset('allassets/AdminTheme/Theme02/images/logo-sm.png') }} " alt="" height="24">
                            </span>
                        </a>
                    </li>
        ...
        <div class="container-fluid">
                    ...
                    <div class="card-box">
                        ...
                        <div class="mb-3 mt-4">
                            <div class="float-right d-none d-xl-block">
                                <img src="{{ asset('allassets/AdminTheme/Theme02/images/cards/visa.png') }} " alt="user-card" height="28" />
                                <img src="{{ asset('allassets/AdminTheme/Theme02/images/cards/master.png') }} " alt="user-card" height="28" />
                                <img src="{{ asset('allassets/AdminTheme/Theme02/images/cards/american-express.png') }} " alt="user-card" height="28" />
                            </div>
            ...
            <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table table-centered table-hover mb-0" id="datatable">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-2.jpg') }}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                            <span class="ml-2">Imelda J. Stanberry</span>
                                        </td>
                                        <td>
                                            <img src="{{ asset('allassets/AdminTheme/Theme02/images/cards/visa.png') }} " alt="user-card" height="24" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-3.jpg') }}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                            <span class="ml-2">Francisca S. Lobb</span>
                                        </td>
                                        <td>
                                            <img src="{{ asset('allassets/AdminTheme/Theme02/images/cards/master.png') }} " alt="user-card" height="24" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-1.jpg') }}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                            <span class="ml-2">James A. Wert</span>
                                        </td>
                                        <td>
                                            <img src="{{ asset('allassets/AdminTheme/Theme02/images/cards/amazon.png') }} " alt="user-card" height="24" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-4.jpg') }}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                            <span class="ml-2">Dolores J. Pooley</span>
                                        </td>
                                        <td>
                                            <img src="{{ asset('allassets/AdminTheme/Theme02/images/cards/american-express.png') }} " alt="user-card" height="24" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-5.jpg') }}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                            <span class="ml-2">Karen I. McCluskey</span>
                                        </td>
                                        <td>
                                            <img src="{{ asset('allassets/AdminTheme/Theme02/images/cards/discover.png') }} " alt="user-card" height="24" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-6.jpg') }}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-7.jpg') }}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-8.jpg') }}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-9.jpg') }}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-10.jpg') }}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                ...
                <div class="col-xl-3">
                    ...
                    <div class="card-box">
                        <div class="media">
                            <img class="mr-3 rounded-circle bx-shadow-lg" src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-4.jpg') }}" alt="Generic placeholder image" height="80">
    ...
    <div class="right-bar">
        ...
        <div class="slimscroll-menu">
            ...
            <div class="user-box">
                <div class="user-img">
                    <img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-1.jpg') }}" alt="user-img" title="Mat Helme" class="rounded-circle img-fluid">
            ...
            <div class="p-3">
                <div class="inbox-widget">
                    <div class="inbox-item">
                        <div class="inbox-item-img"><img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-1.jpg') }}" class="rounded-circle" alt=""></div>
                        <p class="inbox-item-author"><a href="javascript: void(0);" class="text-dark">Chadengle</a></p>
                        <p class="inbox-item-text">Hey! there I'm available...</p>
                        <p class="inbox-item-date">13:40 PM</p>
                    </div>
                    <div class="inbox-item">
                        <div class="inbox-item-img"><img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-2.jpg') }}" class="rounded-circle" alt=""></div>
                        <p class="inbox-item-author"><a href="javascript: void(0);" class="text-dark">Tomaslau</a></p>
                        <p class="inbox-item-text">I've finished it! See you so...</p>
                        <p class="inbox-item-date">13:34 PM</p>
                    </div>
                    <div class="inbox-item">
                        <div class="inbox-item-img"><img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-3.jpg') }}" class="rounded-circle" alt=""></div>
                    ...
                    <div class="inbox-item">
                        <div class="inbox-item-img"><img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-4.jpg') }}" class="rounded-circle" alt=""></div>
                    ...
                    <div class="inbox-item">
                        <div class="inbox-item-img"><img src="{{ asset('allassets/AdminTheme/Theme02/images/users/avatar-5.jpg') }}" class="rounded-circle" alt=""></div>
    ...
    <!-- Vendor js -->
    <script src="{{ asset('allassets/AdminTheme/Theme02/js/vendor.min.js') }} "></script>

    <!-- KNOB JS -->
    <script src="{{ asset('allassets/AdminTheme/Theme02/libs/jquery-knob/jquery.knob.min.js') }} "></script>
    <!-- Chart JS -->
    <script src="{{ asset('allassets/AdminTheme/Theme02/libs/chart-js/Chart.bundle.min.js') }} "></script>

    <!-- Jvector map -->
    <script src="{{ asset('allassets/AdminTheme/Theme02/libs/jqvmap/jquery.vmap.min.js') }} "></script>
    <script src="{{ asset('allassets/AdminTheme/Theme02/libs/jqvmap/jquery.vmap.usa.js') }} "></script>

    <!-- Datatable js -->
    <script src="{{ asset('allassets/AdminTheme/Theme02/libs/datatables/jquery.dataTables.min.js') }} "></script>
    <script src="{{ asset('allassets/AdminTheme/Theme02/libs/datatables/dataTables.bootstrap4.min.js') }} "></script>
    <script src="{{ asset('allassets/AdminTheme/Theme02/libs/datatables/dataTables.responsive.min.js') }} "></script>
    <script src="{{ asset('allassets/AdminTheme/Theme02/libs/datatables/responsive.bootstrap4.min.js') }} "></script>

    <!-- Dashboard Init JS -->
    <script src="{{ asset('allassets/AdminTheme/Theme02/js/pages/dashboard.init.js') }} "></script>

    <!-- App js -->
    <script src="{{ asset('allassets/AdminTheme/Theme02/js/app.min.js') }} "></script>
