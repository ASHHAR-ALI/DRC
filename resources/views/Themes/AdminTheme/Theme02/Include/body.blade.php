   ...
   <div class="pre-loader-box">
    ...
    <div class="header">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <div class="notification-list mx-h-350 customscroll">
                            <ul>
                                <li>
                                    <a href="#">
                                        <img src="{{ asset('/allassets/AdminTheme/DeskAppTheme/vendors/images/img.jpg') }}"
                                            alt="" />
                                        <h3>John Doe</h3>
                                        <p>
                                ...
                                <li>
                                    <a href="#">
                                        <img src="{{ asset('/allassets/AdminTheme/DeskAppTheme/vendors/images/photo1.jpg') }}"
                                            alt="" />
                                        <h3>Lea R. Frith</h3>
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipisicing
                                ...
                                <li>
                                    <a href="#">
                                        <img src="{{ asset('/allassets/AdminTheme/DeskAppTheme/vendors/images/photo2.jpg') }}"
                                            alt="" />
                                ...
                                <li>
                                    <a href="#">
                                        <img src="{{ asset('/allassets/AdminTheme/DeskAppTheme/vendors/images/photo3.jpg') }}"
                                            alt="" />
                                        <h3>John Doe</h3>
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipisicing
                                ...
                                <li>
                                    <a href="#">
                                        <img src="{{ asset('/allassets/AdminTheme/DeskAppTheme/vendors/images/photo4.jpg') }}"
                                            alt="" />
     ...
     <a href="https://github.com/dropways/deskapp" target="_blank"
      ><img src="{{ asset('/allassets/AdminTheme/DeskAppTheme/vendors/images/github.svg') }}" alt=""
     /></a>
    </div> -->
        </div>
    </div>
    ...
    <div class="left-side-bar">
        <div class="brand-logo">
            <a href="index.html">
                <img src="{{ asset('/allassets/AdminTheme/DeskAppTheme/vendors/images/deskapp-logo.svg') }}"
                    alt="" class="dark-logo" />
                    ...
                    <li>
                        <a href="https://dropways.github.io/deskapp-free-single-page-website-template/"
                            ...
                            <span class="mtext">Landing Page
                                <img src="{{ asset('/allassets/AdminTheme/DeskAppTheme/vendors/images/coming-soon.png') }}"
                                    alt="" width="25" /></span>
                        </a>
                    </li>
                </ul>
                ...
                <div class="col-lg-4 col-md-12 mb-20">
                    <div class="card-box height-100-p pd-20 min-height-200px">
                        <div class="max-width-300 mx-auto">
                            <img src="{{ asset('/allassets/AdminTheme/DeskAppTheme/vendors/images/upgrade.svg') }}"
                                alt="" />
                        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img src="{{ asset('/allassets/AdminTheme/DeskAppTheme/vendors/images/photo5.jpg') }}"
                                            class="border-radius-100 shadow" width="40" height="40"
                                            alt="" />
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img src="{{ asset('/allassets/AdminTheme/DeskAppTheme/vendors/images/photo6.jpg') }}"
                                            class="border-radius-100 shadow" width="40" height="40"
                                            alt="" />
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img src="{{ asset('/allassets/AdminTheme/DeskAppTheme/vendors/images/photo9.jpg') }}"
                                            class="border-radius-100 shadow" width="40" height="40"
                                            alt="" />
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img src="{{ asset('/allassets/AdminTheme/DeskAppTheme/vendors/images/photo8.jpg') }}"
                                            class="border-radius-100 shadow" width="40" height="40"
                                            alt="" />
                                    </div>
                                    <div class="txt">
            ...
            <div class="row">
                <div class="col-md-4 mb-20">
                    <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                        <div class="img pb-30">
                            <img src="{{ asset('/allassets/AdminTheme/DeskAppTheme/vendors/images/medicine-bro.svg') }}"
                                alt="" />
                        </div>
                        <div class="content">
                ...
                <div class="col-md-4 mb-20">
                    <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                        <div class="img pb-30">
                            <img src="{{ asset('/allassets/AdminTheme/DeskAppTheme/vendors/images/remedy-amico.svg') }}"
                                alt="" />
                        </div>
                        <div class="content">
                ...
                <div class="col-md-4 mb-20">
                    <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                        <div class="img pb-30">
                            <img src="{{ asset('/allassets/AdminTheme/DeskAppTheme/vendors/images/paper-map-cuate.svg') }}"
                                alt="" />
                        </div>
                        <div class="content">
