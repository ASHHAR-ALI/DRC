...
<head>
    ...
    @include('Themes.AdminTheme.Theme03.LinkScripts.headlinks')

    {{-- <link rel="icon" href="{{ asset('/allassets/DefaultTheme/images/DRC.png') }} " type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('/allassets/DefaultTheme/images/DRC.png') }} " type="image/x-icon">
    <!-- Google font-->
    ...
    <!-- Font Awesome-->
    <link rel="stylesheet" type="text/css" href="{{ asset('/allassets/AdminTheme/Theme03/css/vendors/font-awesome.css') }} ">
    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="{{ asset('/allassets/AdminTheme/Theme03/css/vendors/flag-icon.css') }} ">
    <!-- ico-font-->
    <link rel="stylesheet" type="text/css" href="{{ asset('/allassets/AdminTheme/Theme03/css/vendors/icofont.css') }} ">
    <!-- Prism css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('/allassets/AdminTheme/Theme03/css/vendors/prism.css') }} ">
    <!-- Chartist css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('/allassets/AdminTheme/Theme03/css/vendors/chartist.css') }} ">
    <!-- Bootstrap css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('/allassets/AdminTheme/Theme03/css/vendors/bootstrap.css') }} ">
    <!-- App css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('/allassets/AdminTheme/Theme03/css/style.css') }} "> --}}
</head>
...
<body>
    ...
    @include('Themes.AdminTheme.Theme03.LinkScripts.scripttags')

    {{-- <!-- latest jquery-->
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/jquery-3.3.1.min.js') }} "></script>
    <!-- Bootstrap js-->
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/bootstrap.bundle.min.js') }} "></script>
    <!-- feather icon js-->
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/icons/feather-icon/feather.min.js') }} "></script>
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/icons/feather-icon/feather-icon.js') }} "></script>
    <!-- Sidebar jquery-->
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/sidebar-menu.js') }} "></script>
    <!--chartist js-->
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/chart/chartist/chartist.js') }} "></script>
    <!--chartjs js-->
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/chart/chartjs/chart.min.js') }} "></script>
    <!-- lazyload js-->
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/lazysizes.min.js') }} "></script>
    <!--copycode js-->
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/prism/prism.min.js') }} "></script>
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/clipboard/clipboard.min.js') }} "></script>
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/custom-card/custom-card.js') }} "></script>
    <!--counter js-->
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/counter/jquery.waypoints.min.js') }} "></script>
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/counter/jquery.counterup.min.js') }} "></script>
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/counter/counter-custom.js') }} "></script>
    <!--peity chart js-->
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/chart/peity-chart/peity.jquery.js') }} "></script>
    <!-- Apex Chart Js -->
    <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
    <!--sparkline chart js-->
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/chart/sparkline/sparkline.js') }} "></script>
    <!--Customizer admin-->
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/admin-customizer.js') }} "></script>
    <!--dashboard custom js-->
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/dashboard/default.js') }} "></script>
    <!--right sidebar js-->
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/chat-menu.js') }} "></script>
    <!--height equal js-->
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/height-equal.js') }} "></script>
    <!-- lazyload js-->
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/lazysizes.min.js') }} "></script>
    <!--script admin-->
    <script src="{{ asset('/allassets/AdminTheme/Theme03/js/admin-script.js') }} "></script> --}}
    {{-- </body>
