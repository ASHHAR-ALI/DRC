...
<head>
    ...
    @include('Themes.AdminTheme.Theme01.LinkScripts.headlinks')

    {{-- <!-- App favicon -->
<link rel="shortcut icon" href="{{ asset('/allassets/GreevaTheme/images/favicon.ico') }}">
...
<!-- jvectormap -->
<link href="{{ asset('/allassets/GreevaTheme/libs/jqvmap/jqvmap.min.css') }}" rel="stylesheet" />

<!-- DataTables -->
<link href="{{ asset('/allassets/GreevaTheme/libs/datatables/dataTables.bootstrap4.min.css') }}" rel="stylesheet"
    type="text/css" />
<link href="{{ asset('/allassets/GreevaTheme/libs/datatables/responsive.bootstrap4.min.css') }}" rel="stylesheet"
    type="text/css" />

<!-- App css -->
<link href="{{ asset('/allassets/GreevaTheme/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
<link href="{{ asset('/allassets/GreevaTheme/css/icons.min.css') }}" rel="stylesheet" type="text/css" />
<link href="{{ asset('/allassets/GreevaTheme/css/app.min.css') }}" rel="stylesheet" type="text/css" />
...
<body>
                ...
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown d-none d-lg-block">
                        <a class="nav-link dropdown-toggle mr-0 waves-effect waves-light" data-toggle="dropdown"
                            ...
                            <img src="{{ asset('/allassets/GreevaTheme/images/flags/us.jpg') }}" alt="user-image"
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('/allassets/GreevaTheme/images/flags/germany.jpg') }}"
                            ...
                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('/allassets/GreevaTheme/images/flags/italy.jpg') }}"
                                    alt="user-image" class="mr-1" height="12"> <span
                            ...
                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('/allassets/GreevaTheme/images/flags/spain.jpg') }}"
                                    alt="user-image" class="mr-1" height="12"> <span
                            ...
                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('/allassets/GreevaTheme/images/flags/russia.jpg') }}"
                                    alt="user-image" class="mr-1" height="12"> <span
                            ...
                            <div class="slimscroll noti-scroll">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon">
                                        <img src="{{ asset('/allassets/GreevaTheme/images/users/avatar-2.jpg') }}"
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon">
                                        <img src="{{ asset('/allassets/GreevaTheme/images/users/avatar-4.jpg') }}"
                                            class="img-fluid rounded-circle" alt="" />
                                    </div>
                ...
                <ul class="list-unstyled menu-left mb-0">
                    <li class="float-left logo-box">
                        <a href="index.html" class="logo">
                            <span class="logo-lg">
                                <img src="{{ asset('/allassets/GreevaTheme/images/logo-light.png') }}"
                                    alt="" height="22">
                            </span>
                            <span class="logo-sm">
                                <img src="{{ asset('/allassets/GreevaTheme/images/logo-sm.png') }}"
                                    alt="" height="24">
                            </span>
                        </a>
                    </li>
            ...
            <div class="container-fluid">
                <div id="navigation">
                    ...
                    <ul class="navigation-menu">
                        ...
                        <li class="has-submenu">
                            <a href="#"> <i class="dripicons-briefcase"></i>UI Elements <div
                        ...
                        <li class="has-submenu">
                            <a href="#"> <i class="dripicons-view-apps"></i>Layouts <div class="arrow-down">
                                </div></a>
                            <ul class="submenu">
                                <li>
                        ...
                        <li class="has-submenu">
                            <a href="#"> <i class="dripicons-duplicate"></i>Pages <div class="arrow-down">
                                </div></a>
                            <ul class="submenu megamenu">
                                <li>
                                    <ul>
    ...
    {{-- @include('Themes.AdminTheme.Theme01.LinkScripts.scripttags') --}}
