...
@php
    $guards = ['admin', 'disputer', 'member', 'againstdisputer'];
    $layout = 'welcome';
        ...
        <section class="mb-lg-9 mb-5">
            <div class="container">
                ...
                <div class="row gy-5">
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <figure class="mb-4 zoom-img">
                            <img src="{{ asset('/allassets/images/about/sj3.png') }}" alt="team"
                                class="rounded-3 img-fluid" />
                        </figure>
                        <div class="mb-4">
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <figure class="mb-4 zoom-img">
                            <img src="{{ asset('/allassets/images/about/sj4.png') }}" alt="team"
                                class="rounded-3 img-fluid" />
                        </figure>
                        <div class="mb-4">
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <figure class="mb-4 zoom-img">
                            <img src="{{ asset('/allassets/images/about/sj5.png') }}" alt="team"
                                class="rounded-3 img-fluid" />
                        </figure>
                        <div class="mb-4">
