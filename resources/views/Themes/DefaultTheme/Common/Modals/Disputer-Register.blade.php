                                    ...
                                    <form class="row g-3" action="{{ asset('/submit-registration') }}" method="post">
                                        ...
                                        <div class="col-lg-4 col-md-12">
                                            ...
                                            <input type="text" name="cnic" class="form-control" id="userCnicInput"
                                                maxlength="13" placeholder="Enter CNIC" required />
                                        ...
                                        <div class="col-lg-4 col-md-12">
                                            ...
                                            <input type="text" name="contact" class="form-control"
                                                id="userContactInput" maxlength="11" placeholder="Enter Contact"
                                                required />
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-lg-4 col-md-12">
                                                ...
                                                <input type="text" name="dispute_person_address"
                                                    class="form-control" id="disputePersonAddressInput"
                                                    placeholder="Enter Dispute Person Address"  />
                ...
                <div class="container">
                    <div class="wrapper">
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card shadow-sm">
                                <div class="card-body tablebg">
                                    <form class="row g-3" action="{{ asset('/insert-disputer') }}" method="post">
                                        @csrf
                                        ...
                                        <div class="col-lg-4 col-md-12">
                                            ...
                                            <input type="text" name="cnic" class="form-control"
                                                id="userCnicInput" maxlength="13" placeholder="Enter CNIC"
                                                required />
                                            <div class="invalid-feedback">Please enter CNIC.</div>
                                        </div>
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-lg-4 col-md-12 mt-3">
                                                ...
                                                <input type="text" name="dispute_person_contact_number"
                                                    ...
                                                    id="disputePersonContactInput"
                                                    placeholder="Enter Dispute Person Contact" />
                                                <div class="invalid-feedback">Please enter disputePerson Contact.</div>
                                            </div>
