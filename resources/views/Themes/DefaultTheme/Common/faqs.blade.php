                                                    ...
                                                    <div class="col-lg-7 col-md-6">
                                                        <div class="pb-4 border-bottom">
                                                            ...
                                                            <p class="mb-0">
                                                                ...
                                                                form and then submit the dispute by giving the required details.
                                                            </p>
                                                        </div>
                                                        <div class="py-4 border-bottom">
                                                            <h4 class="mb-3">Will the dispute comments be recorded for reviewing the case?</h4>
                                                            <p class="mb-0">
                                                                Yes, the comments of the disputers and the member will be recorded so that both of the disputer and member can go through the details and verify the authenticity of the case.
                                                            </p>
                                                        </div>
                                                        <div class="py-4 border-bottom">
                                                            ...
                                                            <p class="mb-0">
                                                                Yes, Final Decision on the case will be shown to the disputer involved in the disputes.
                                                            </p>
                                                        </div>
                                                        <div class="py-4 border-bottom">
