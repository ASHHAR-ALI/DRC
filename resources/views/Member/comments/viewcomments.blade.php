...
@section('content')
    ...
    <div class="container">
        <div class="row mb-3 text-center">
            <div class="col-12 p-3 top-0 start-0 ">
                ...
                @else
                    <a class="btn btn-primary text-white bg-dark mx-auto" data-bs-toggle="modal"
                        data-bs-target="#addCommentByMemberModal">Add New Comment</a>
                @endif
                ...
                <div class="col-12 p-3">
                    ...
                    @else
                        {{-- <input class="justify-content-end" type="text" placeholder="Write comments"
                            data-bs-toggle="modal" data-bs-target="#addCommentByMemberModal"> --}}
    ...
    <!-- ------------------------The Bootstrap Modal for Adding the Comment Form By Member ------------------------ -->


    <!-- -------------------------------------------Modal for View the Details of the Records ------------------------------------------- -->
    <div class="modal fade" id="addCommentByMemberModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="addCommentByMemberModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                {{-- <div class="modal-header justify-content-center text-center">
                    <h5 class="modal-title text-center" id="addCommentByMemberModalLabel">Details</h5>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form class="p-3 mt-1" action="{{ route('addcomment', ['id' => $dispute->id]) }}"
                    ...
                    <div class="container">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                @if ($dispute->members->isNotEmpty() && $dispute->dispute_status === 3 && $dispute->assigned_date !== null)
                                    <div class="text-center"> The Final Decision </div>

                                    <form class="p-3 mt-1" action="{{ route('finalreview', ['id' => $dispute->id]) }}"
                                        method="post">
                                        @csrf

                                        <label for="final_decision_favor">In Favour of</label>
                                        <select class="form-select d-flex align-items-center col tablebg text-success"
                                            name="final_decision_favor" id="final_decision_favor">
                                            <option class="text-success" value="0"> Favour of Disputer</option>
                                            <option class="text-success" value="1"> Favour of Against Disputer
                                            </option>
                                        </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 form-group">
                                                <label class="fw-bold">Your Final Review</label>
                                                <textarea class="form-control" name="final_review" id="final_review" cols="30" rows="4"
                                ...
                                @elseif ($dispute->members->isNotEmpty() && $dispute->dispute_status == 4 && $dispute->assigned_date == 4)
                                    <label class="btn btn-success btn-sm mt-1">Dispute Resolved (Closed)</label>
                                @endif
    ...
    {{-- The second modal for Update Hearing Date --}}
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-5 mx-auto">
                                    <form action="{{ route('updateassigndate', ['dispute_id' => $dispute->id]) }}"
                                        ...
                                        @csrf
                                        <input type="hidden" name="dispute_id" value="{{ $dispute->id }}">
                                        <input class="p-2 text-success" type="date" name="assigned_date"
                                            id="assigned_date" class="form-control" required>
