                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a class="text-decoration-none text-success"
                                                    href="{{ asset('/memberdisputedetailview') }}">All Disputes</td></a>
                                        </tr>

                                        <tr>
                                            <td><a class="text-decoration-none text-success"
                                                    href="{{ asset('/membernewdisputeview') }}">New Disputes</td></a>
                                        </tr>

                                        <tr>
                                            <td><a class="text-decoration-none text-success"
                                                    href="{{ asset('/memberscheduledisputeview') }}">Schedule Dispute</td>
                                            </a>
                                        </tr>

                                        <tr>
                                            <td><a class="text-decoration-none text-success"
                                                    href="{{ asset('/memberinprogressdisputeview') }}">In Progress Disputes
                                            </td></a>
                                        </tr>

                                        <tr>
                                            <td><a class="text-decoration-none text-success"
                                                    href="{{ asset('/membercompleteddisputeview') }}">Completed Disputes
                                            </td></a>
                                        </tr>
                                    </tbody>
                                </table>
