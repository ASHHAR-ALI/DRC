                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a class="text-decoration-none text-success"
                                                    href="{{ asset('/adisputedetailview') }}">All Disputes</td></a>
                                        </tr>
                                        <tr>
                                            <td><a class="text-decoration-none text-success"
                                                    href="{{ asset('/apendingdisputeview') }}">Pending Disputes</td></a>
                                        </tr>

                                        <tr>
                                            <td><a class="text-decoration-none text-success"
                                                    href="{{ asset('/aassigneddisputeview') }}">Assigned Disputes</td></a>
                                        </tr>

                                        <tr>
                                            <td><a class="text-decoration-none text-success"
                                                    href="{{ asset('/adateassigneddisputeview') }}">Date Assigned Disputes
                                            </td></a>
                                        </tr>

                                        <tr>
                                            <td><a class="text-decoration-none text-success"
                                                    href="{{ asset('/ainprogressdisputeview') }}">In Progress Disputes</td>
                                            </a>
                                        </tr>

                                        <tr>
                                            <td><a class="text-decoration-none text-success"
                                                    href="{{ asset('/acompleteddisputeview') }}">Completed Disputes</td></a>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
