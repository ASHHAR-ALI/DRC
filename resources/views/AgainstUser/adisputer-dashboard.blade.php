...
@section('title', 'Dispute Person Dashboard')
...
<div class="container">
    ...
    <h3 class="text-center">Welcome {{ $againstdisputer->dispute_person_name}} </h3>

    <div class="row mt-5 text-center">
        <div class="col-xl-6 col-lg-6">
            <a href="{{ asset('/adisputedetailview') }}">
        ...
        <div class="col-xl-6 col-lg-6">
            <a href="{{ asset('/aassigneddisputeview') }}">
                <div class="card l-bg-cherry">
                    <div class="card-statistic-3 p-4">
                        <div class="card-icon card-icon-large"><i class="fas fa-users"></i></div>
                        <div class="mb-4">
        ...
        <div class="col-xl-6 col-lg-6">
            <a href="{{ asset('/adateassigneddisputeview') }}">
                <div class="card l-bg-cherry">
                    <div class="card-statistic-3 p-4">
                        <div class="card-icon card-icon-large"><i class="fas fa-users"></i></div>
                        <div class="mb-4">
        ...
        <div class="col-xl-6 col-lg-6">
            <a href="{{ asset('/ainprogressdisputeview') }}">
        ...
        <div class="col-xl-6 col-lg-6">
            <a href="{{ asset('/acompleteddisputeview') }}">
                <div class="card l-bg-blue-dark">
                    <div class="card-statistic-3 p-4">
                        <div class="card-icon card-icon-large"><i class="fas fa-users"></i></div>
                        <div class="mb-4">
...
@endsection
    ...
    {{-- <div class="container">
        <div class="col-12">
            <h3 class="text-center">Welcome {{ $againstdisputers->name }}</h3>
