                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a class="text-decoration-none text-success"
                                                    href="{{ asset('/disputesdetail') }}">All Disputes</td></a>
                                        </tr>
                                        <tr>
                                            <td><a class="text-decoration-none text-success"
                                                    href="{{ asset('/pendingdisputesdetail') }}">Pending Disputes</td></a>
                                        </tr>

                                        <tr>
                                            <td><a class="text-decoration-none text-success"
                                                    href="{{ asset('/assigneddisputesdetail') }}">Assigned Disputes</td></a>
                                        </tr>

                                        <tr>
                                            <td><a class="text-decoration-none text-success"
                                                    href="{{ asset('/dateassigneddisputedetail') }}">Date Assigned Disputes
                                            </td></a>
                                        </tr>

                                        <tr>
                                            <td><a class="text-decoration-none text-success"
                                                    href="{{ asset('/inprogressdisputesdetail') }}">In Progress Disputes
                                            </td></a>
                                        </tr>
                                        ...
                                        <tr>
                                            <td><a class="text-decoration-none text-success"
                                                    href="{{ asset('/completeddisputesdetail') }}">Completed Disputes</td>
                                            </a>
                                        </tr>
                                ...
                                <table class="table table-bordered table-dark table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img id="againstdisputerImage" src="" alt="Against Disputer Image" height="100px"
