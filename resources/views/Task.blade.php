...
<head>
    ...
    <link rel="icon" href="{{asset('allassets/Multicart/images/dashboard/favicon.png')}}" type="image/x-icon">
    <link rel="shortcut icon" href="{{asset('/Multicart/images/dashboard/favicon.png')}}"
        type="image/x-icon">
    <title>Multikart - Premium Admin Template</title>

    <!-- Google font-->
    <link rel="stylesheet"
        href="../../css2?family=Work+Sans:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,500;1,600;1,700;1,800;1,900&display=swap">

    <link rel="stylesheet"
        href="../../css2-1?family=Nunito:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap">


    <!-- Font Awesome-->
    <link rel="stylesheet" type="text/css" href="{{asset('allassets/Multicart/css/vendors/font-awesome.css')}}">

    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="{{asset('allassets/Multicart/css/vendors/flag-icon.css')}}">

    <!-- ico-font-->
    <link rel="stylesheet" type="text/css" href="{{asset('allassets/Multicart/css/vendors/icofont.css')}}">

    <!-- Prism css-->
    <link rel="stylesheet" type="text/css" href="{{asset('allassets/Multicart/css/vendors/prism.css')}}">

    <!-- Chartist css -->
    <link rel="stylesheet" type="text/css" href="{{asset('allassets/Multicart/css/vendors/chartist.css')}}">

    <!-- Bootstrap css-->
    <link rel="stylesheet" type="text/css" href="{{asset('allassets/Multicart/css/vendors/bootstrap.css')}}">

    <!-- App css-->
    <link rel="stylesheet" type="text/css" href="{{asset('allassets/Multicart/css/style.css')}}">
</head>
                    ...
                    <div class="logo-wrapper">
                        <a href="index.html">
                            <img class="blur-up lazyloaded d-block d-lg-none"
                                src="{{asset('allassets/Multicart/images/dashboard/multikart-logo-black.png')}}"
                                alt="">
                        </a>
                    </div>
                </div>
                        ...
                        <li class="onhover-dropdown">
                            <div class="media align-items-center">
                                <img class="align-self-center pull-right img-50 blur-up lazyloaded"
                                    src="{{asset('allassets/Multicart/images/dashboard/user3.jpg')}}"
                                    alt="header-user">
            ...
            <div class="page-sidebar">
                    ...
                    <div class="logo-wrapper">
                        <a href="index.html">
                            <img class="d-none d-lg-block blur-up lazyloaded"
                                src="{{asset('allassets/Multicart/images/dashboard/multikart-logo.png')}}"
                                alt="">
                        </a>
                    </div>
                </div>
                <div class="sidebar custom-scrollbar">
                    ...
                    <div class="sidebar-user">
                        <img class="img-60" src="{{asset('allassets/Multicart/images/dashboard/user3.jpg')}}"
                            alt="#">
                        <div>
                                ...
                                <ul class="list">
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded"
                                            src="{{asset('allassets/Multicart/images/dashboard/user.jpg')}}"
                                            alt="">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded"
                                            src="{{asset('allassets/Multicart/images/dashboard/user1.jpg')}}"
                                            alt="">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded"
                                            src="{{asset('allassets/Multicart/images/dashboard/user2.jpg')}}"
                                            alt="">
                                        <div class="status-circle online"></div>
                                        <div class="about">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded"
                                            src="{{asset('allassets/Multicart/images/dashboard/user5.jpg')}}"
                                            alt="">
                                        <div class="status-circle away"></div>
                                        <div class="about">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded"
                                            src="{{asset('allassets/Multicart/images/dashboard/designer.jpg')}}"
                                            alt="">
                                        <div class="status-circle online"></div>
                                        <div class="about">
...
&lt;div class="user-status table-responsive products-table"&gt;
    &lt;table class="table table-bordernone mb-0"&gt;
        ...
        &lt;tbody&gt;
                &lt;tr&gt;
                    &lt;td class="bd-t-none u-s-tb"&gt;
                        &lt;div class="align-middle image-sm-size"&gt;&lt;img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{asset('allassets/Multicart/images/dashboard/user2.jpg')}}" alt="" data-original-title="" title=""&gt;
                        &lt;div class="d-inline-block"&gt;
            ...
            &lt;tr&gt;
                &lt;td class="bd-t-none u-s-tb"&gt;
                    &lt;div class="align-middle image-sm-size"&gt;&lt;img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{asset('allassets/Multicart/images/dashboard/user1.jpg')}}" alt="" data-original-title="" title=""&gt;
                    &lt;div class="d-inline-block"&gt;
            ...
            &lt;tr&gt;
                &lt;td class="bd-t-none u-s-tb"&gt;
                    &lt;div class="align-middle image-sm-size"&gt;&lt;img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{asset('allassets/Multicart/images/dashboard/user3.jpg')}}" alt="" data-original-title="" title=""&gt;
                    &lt;div class="d-inline-block"&gt;
            ...
            &lt;tr&gt;
                &lt;td class="bd-t-none u-s-tb"&gt;
                    &lt;div class="align-middle image-sm-size"&gt;&lt;img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{asset('allassets/Multicart/images/dashboard/user.jpg')}}" alt="" data-original-title="" title=""&gt;
                    &lt;div class="d-inline-block"&gt;
            ...
            &lt;tr&gt;
                &lt;td class="bd-t-none u-s-tb"&gt;
                    &lt;div class="align-middle image-sm-size"&gt;&lt;img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{asset('allassets/Multicart/images/dashboard/designer.jpg')}}" alt="" data-original-title="" title=""&gt;
                    &lt;div class="d-inline-block"&gt;
...
&lt;/div&gt;</code>
    ...
    <!-- latest jquery-->
    <script src="{{asset('allassets/Multicart/js/jquery-3.3.1.min.js')}}"></script>

    <!-- Bootstrap js-->
    <script src="{{asset('allassets/Multicart/js/bootstrap.bundle.min.js')}}"></script>

    <!-- feather icon js-->
    <script src="{{asset('allassets/Multicart/js/icons/feather-icon/feather.min.js')}}"></script>
    <script src="{{asset('allassets/Multicart/js/icons/feather-icon/feather-icon.js')}}"></script>

    <!-- Sidebar jquery-->
    <script src="{{asset('allassets/Multicart/js/sidebar-menu.js')}}"></script>

    <!--chartist js-->
    <script src="{{asset('allassets/Multicart/js/chart/chartist/chartist.js')}}"></script>

    <!--chartjs js-->
    <script src="{{asset('allassets/Multicart/js/chart/chartjs/chart.min.js')}}"></script>

    <!-- lazyload js-->
    <script src="{{asset('allassets/Multicart/js/lazysizes.min.js')}}"></script>

    <!--copycode js-->
    <script src="{{asset('allassets/Multicart/js/prism/prism.min.js')}}"></script>
    <script src="{{asset('allassets/Multicart/js/clipboard/clipboard.min.js')}}"></script>
    <script src="{{asset('allassets/Multicart/js/custom-card/custom-card.js')}}"></script>

    <!--counter js-->
    <script src="{{asset('allassets/Multicart/js/counter/jquery.waypoints.min.js')}}"></script>
    <script src="{{asset('allassets/Multicart/js/counter/jquery.counterup.min.js')}}"></script>
    <script src="{{asset('allassets/Multicart/js/counter/counter-custom.js')}}"></script>

    <!--peity chart js-->
    <script src="{{asset('allassets/Multicart/js/chart/peity-chart/peity.jquery.js')}}"></script>

    <!-- Apex Chart Js -->
    <script src="../../npm/apexcharts"></script>

    <!--sparkline chart js-->
    <script src="{{asset('allassets/Multicart/js/chart/sparkline/sparkline.js')}}"></script>

    <!--Customizer admin-->
    <script src="{{asset('allassets/Multicart/js/admin-customizer.js')}}"></script>

    <!--dashboard custom js-->
    <script src="{{asset('allassets/Multicart/js/dashboard/default.js')}}"></script>

    <!--right sidebar js-->
    <script src="{{asset('allassets/Multicart/js/chat-menu.js')}}"></script>

    <!--height equal js-->
    <script src="{{asset('allassets/Multicart/js/height-equal.js')}}"></script>

    <!-- lazyload js-->
    <script src="{{asset('allassets/Multicart/js/lazysizes.min.js')}}"></script>

    <!--script admin-->
    <script src="{{asset('allassets/Multicart/js/admin-script.js')}}"></script>
</body>
